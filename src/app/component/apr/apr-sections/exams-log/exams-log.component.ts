...
@Component({
  selector: 'app-exams-log',
  templateUrl: './exams-log.component.html',
  styleUrls: ['./exams-log.component.css']
})
export class ExamsLogComponent implements OnInit {
 ...
 dropDownBindingArray:any =[];
  ...
  payload(){
    return this.notesForm = this.fb.group({
        formLayout: ['vertical'],
