...
export class ContactsComponent implements OnInit {
  ...
  public annualPerformanceReportSectionOnePartTwoForm: FormGroup;
 ...
 dropDownBindingArray:any =[];
  ...
  payload(){
    return this.annualPerformanceReportSectionOnePartTwoForm = this.fb.group({
        formLayout: ['vertical'],
              useFiltersFromThisPage: [null],
              contactDateFrom: [null],
              contactDateTo: [null],
              reContactDateFrom: [null],
              reContactDateTo: [null],
              reContacted: [null],
              contactBy: [null],
              contactType: [null],
              contactCount: [null],
