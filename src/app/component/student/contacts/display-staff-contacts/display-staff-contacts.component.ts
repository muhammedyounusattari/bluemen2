...
import { DispStaffContactsService } from 'src/app/services/staff/disp-staff-contacts.service';
...
@Component({
    selector: 'display-staff-contacts',
    templateUrl: './display-staff-contacts.component.html',
    styleUrls: ['./display-staff-contacts.component.css']
})

export class DisplayStaffContactsComponent implements OnInit {
  ...
  constructor(
    ...
    private staffContactsService: DispStaffContactsService
  ) {
