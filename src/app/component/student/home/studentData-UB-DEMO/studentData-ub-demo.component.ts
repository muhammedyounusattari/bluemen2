...
@Component({
    selector: 'app-student-ub-demo',
    templateUrl: './studentData-ub-demo.component.html',
    styleUrls: ['./studentData-ub-demo.component.css']
})

export class StudentDataUBDemoComponent implements OnInit, AfterViewInit {
